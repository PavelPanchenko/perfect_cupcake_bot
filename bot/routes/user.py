...
MESSAGE_WELCOME_BIG = (
    ...
    '✅ Інтерактивну підтримку через мою Instagram-сторінку <a href="https://www.instagram.com/svitlychnyi_chef">@svitlychnyi_chef</a> – я завжди на зв’язку, щоб відповісти на ваші питання.\n\n'
